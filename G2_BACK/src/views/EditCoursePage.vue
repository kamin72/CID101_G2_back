        ...
        <div class="row py-5">
            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="teacherName" v-model="course.teacher"
                        placeholder="請輸入老師姓名">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="invalid-feedback" v-if="!isEndTimeValid">
                        結束時間必須晚於開始時間
                    </div>
                </div>
                <div class="mb-3">
...
export default {
    ...
    computed: {
        isEndTimeValid() {
            return !this.course.startTime || !this.course.endTime ||
                new Date(this.course.endTime) > new Date(this.course.startTime);
        },
        isFormValid() {
