...
export default {
  ...
  methods: {
        ...
        if (xhr.status === 200) {
          try {
            ...
            if (response.success) {
              ...
              // 圖片預覽
              this.imagePreview = `https://tibamef2e.com/cid101/g2/img/${response.course.course_image}`
            } else {
    ...
    submitForm() {
      ...
      const xhr = new XMLHttpRequest()
      const url = `${import.meta.env.VITE_API_URL}/courseManage/updateCourse.php`
