        ...
        <div class="row py-5">
            ...
            <div class="button-wrap d-flex justify-content-end py-4">
                <div class="right-wrap d-flex">
                        ...
                        <input style="height: 40px;" type="text" class="form-control" placeholder="請輸入文章標題或內容" aria-label="Username" aria-describedby="basic-addon1" v-model="search"/>
                        </div>
                    ...
                    <tr v-for="(item, index) in paginatedNews" :key="item.news_id" style="width: 200px;height: 10px; ">
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id='flexSwitchCheckChecked'  :checked="item.news_active === 1" @change="toggleActive(item)">
                                <label class="form-check-label" for='flexSwitchCheckChecked'>{{ item.news_active === 1 ? '上架' : '下架' }}</label>
                            </div>
                        </td>
                        <td>
            ...
            <div class="card-header">
                ...
                <form @submit.prevent="addUpdateForm" id="addUpdateForm">
                    <div class="mb-3">
                        ...
                        <img v-if="previewImage" :src="previewImage" alt="Image Preview" style="max-width: 100%; height: 100px; margin-top: 10px;">
                        <img v-if="!previewImage && originalImage" :src="'../../../../image/news/' + originalImage" alt="Image" style="max-width: 100%; height: 100px; margin-top: 10px;">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" id="news_content" v-model="newsForm.news_content"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="news_date" class="form-label">發布時間</label>
                        <input type="datetime-local" step="1" class="form-control" id="news_date" v-model="newsForm.news_date">
                    </div>
